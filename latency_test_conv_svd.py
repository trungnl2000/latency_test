...
class ConvLayer_svd(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, SVD_var, active, current_index, forward_time, backward_time):
        ...
        self.conv = wrap_convSVD_with_var_layer(nn.Conv2d(in_channels, out_channels, kernel_size), 
...
def main(**kwargs):
    ...
    for i in range(number_of_iteration):
        ...
        active = True
        # Create layer
        conv_layer_svd = ConvLayer_svd(in_channels, out_channels=out_channels, kernel_size=kernel_size, SVD_var=SVD_var, 
